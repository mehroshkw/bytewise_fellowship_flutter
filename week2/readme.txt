...
In this project, I used Flutter along with Firebase for the backend. For authentication, I implemented Firebase Auth to enable users to sign up and log in to the app securely.

To store and retrieve data from the Firebase Cloud Firestore, I created a class that could add data to a Firestore collection, and a separate class to read that data from Firestore. This allowed for smooth and efficient data storage and retrieval.
